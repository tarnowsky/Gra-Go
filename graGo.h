...
// rozpoznaj kiedy zosta�a klikni�ta 
// strza�ka
#define SPECIAL_CHARACTER 0

// klikni�to / nie klikni�to przycisku
#define PRESSED		1
...
// znaki z kt�rych zbudowana jest plansza
#define CROSS				197
#define LINE				196
...
static struct keyboard_keys {
	int enter =		NOT_PRESSED; // potwierd� wyb�r, zako�cz tur�
	int arrows =	NOT_PRESSED; // poruszanie (g�ra, d�, lewo, prawo)
	int q =			NOT_PRESSED; // zamknij program
	int n =			NOT_PRESSED; // nowa gra
	int escape =	NOT_PRESSED; // anuluj obecn� akcj�
	int i =			NOT_PRESSED; // po�� kamie� na planszy
	int s =			NOT_PRESSED; // zapisz stan gry
	int l =			NOT_PRESSED; // zapisz stan gry
	int f =			NOT_PRESSED; // zako�cz gr�
